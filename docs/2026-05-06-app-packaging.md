# App Packaging Plan — electron-builder for Windows & macOS

> **Origin:** This implementation plan was originally drafted as a Claude Code prompt inside the [`threadbase-streamer`](https://github.com/RonenMars/threadbase-streamer) repo (`.claude/plans/menubar-packaging-prompt.md`). Moved here on 2026-06-01 because it belongs with the menubar code it describes — `threadbase-menubar` is the submodule at `vendor/menubar/` in the streamer.
>
> **Date drafted:** 2026-05-06
> **Status:** Implementation reference. The packaging work has since landed in the menubar repo; this document is kept as a historical record of the brief that drove it.
